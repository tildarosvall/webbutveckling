<script src="https://koda.nu/simple.js"> 
   ...
   var xträdstam2 = 300; 
	...
	var trädstamColor = "brown"; 
  	...
  	var xträdstam11 = 100;
  	var yträdstam11 = 100;
  	var trädstamWidth11 = 110;
  	var trädstamHeight11 = 10;
  	var trädstamColor = "brown";
  
  	var xträdstam12 = 10;
  	var yträdstam12 = 90;
  	var trädstamWidth12 = 100;
  	var trädstamHeight12 = 10;
  	var trädstamColor = "brown";
  	...
  	var xträdstam21 = 300;
  	var yträdstam21 = 170;
  	var trädstamWidth21 = 100;
  	var trädstamHeight21 = 10;
  	var trädstamColor = "brown";
  
  	var xträdstam22 = 220;
  	var yträdstam22 = 150;
  	var trädstamWidth22 = 100;
  	var trädstamHeight22 = 10;
  	var trädstamColor = "brown";
  	...
  	var xträdstam31 = 500;
  	var yträdstam31 = 100;
  	var trädstamWidth31 = 100;
  	var trädstamHeight31 = 10;
  	var trädstamColor = "brown";
  
  	var xträdstam32 = 400;
  	var yträdstam32 = 80;
  	var trädstamWidth32 = 100;
  	var trädstamHeight32 = 10;
  	var trädstamColor = "brown";
  	...
  	var xträdkrona1 = 110;
  	var yträdkrona1 = 20;
  	var trädkronaColor = "green";
  	var trädkrona1Radie = 60;
  
  	var xträdkrona11 = 200;
  	var yträdkrona11 = 80;
  	var trädkronaColor = "green";
  	var trädkrona11Radie = 35;
  
  	var xträdkrona12 = 10;
  	var yträdkrona12 = 70;
  	var trädkronaColor = "green";
  	var trädkrona12Radie = 35;
 	...
 	var xträdkrona2 = 310;
  	var yträdkrona2 = 20;
  	var trädkronaColor = "green";
  	var trädkrona2Radie = 70;
  
  	var xträdkrona21 = 390;
  	var yträdkrona21 = 147;
  	var trädkronaColor = "green";
  	var trädkrona21Radie = 35;
  
  	var xträdkrona22 = 225;
  	var yträdkrona22 = 125;
  	var trädkronaColor = "green";
  	var trädkrona22Radie = 35;
  	...
  	var yträdkrona3 = 20;
  	var trädkronaColor = "green";
  	var trädkrona3Radie = 60;
  
  	var xträdkrona31 = 590;
  	var yträdkrona31 = 75;
  	var trädkronaColor = "green";
  	var trädkrona31Radie = 35;
  
  	var xträdkrona32 = 420;
  	var yträdkrona32 = 60;
  	var trädkronaColor = "green";
  	var trädkrona32Radie = 35;
...
//När x2 värdet kommer över 620, så studsar den tillbaka åt vänster. När x-värdet blir mindre än 21, så studsar den tillbaka åt höger. 
  ...
  if (riktning == "vänster") 
    ...
    { 
		...
		if(x1114svan > 700) x1114svan = 0;
      	if(x2224svan > 700) x2224svan = 0;
      	if(x3334svan > 700) x3334svan = 0;
  ...
  //Rita ut en blå rektangel som ska täcka hela skärmen längst ner, den ska bli havet. X-koordinat= 0, Y-koordinat= 400, havWidth= 700, havHeight= 50. 
   ...
   rectangle(xträdstam11,yträdstam11,trädstamWidth11,trädstamHeight11,trädstamColor); 
   rectangle(xträdstam12,yträdstam12,trädstamWidth12,trädstamHeight12,trädstamColor); 
   rectangle(xträdstam21,yträdstam21,trädstamWidth21,trädstamHeight21,trädstamColor); 
   rectangle(xträdstam22,yträdstam22,trädstamWidth22,trädstamHeight22,trädstamColor); 
   rectangle(xträdstam31,yträdstam31,trädstamWidth31,trädstamHeight31,trädstamColor); 
   rectangle(xträdstam32,yträdstam32,trädstamWidth32,trädstamHeight32,trädstamColor); 
  ...
  //Rita ut en brun rektangel som ska bli trädstammen för ett träd, höger om huset. X-koordinat= 500, Y-koordinat= 200, trädstamWidth= 20, trädstamHeight= 200. 
   ...
   circle(xträdkrona1, yträdkrona1, trädkrona1Radie, trädkronaColor);
   circle(xträdkrona11, yträdkrona11, trädkrona11Radie, trädkronaColor); 
   circle(xträdkrona12, yträdkrona12, trädkrona12Radie, trädkronaColor);
    
   circle(xträdkrona2, yträdkrona2, trädkrona2Radie, trädkronaColor);
   circle(xträdkrona21, yträdkrona21, trädkrona21Radie, trädkronaColor);
   circle(xträdkrona22, yträdkrona22, trädkrona22Radie, trädkronaColor);
    
   circle(xträdkrona3, yträdkrona3, trädkrona3Radie, trädkronaColor);
   circle(xträdkrona31, yträdkrona31, trädkrona31Radie, trädkronaColor);
   circle(xträdkrona32, yträdkrona32, trädkrona32Radie, trädkronaColor);
